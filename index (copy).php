...
<div class="container">
	<a href = "http://tritechsc.org/programs/autobody/" target = "_blank"><button type="button" class="btn btn-danger">AAuto Body Technology </button></a> 
	<a href = "http://tritechsc.org/programs/auto/" target = "_blank"><button type="button" class="btn btn-danger">Auto Systems Technology </button></a> 
	<a href = "http://tritechsc.org/programs/auto/" target = "_blank"><button type="button" class="btn btn-danger">Construction Trades </button></a> 
	<a href = "http://tritechsc.org/programs/auto/" target = "_blank"><button type="button" class="btn btn-danger">Auto Systems Technology </button></a> 
	<a href = "http://tritechsc.org/programs/auto/" target = "_blank"><button type="button" class="btn btn-danger">Auto Systems Technology </button></a> 
	<a href = "http://tritechsc.org/programs/auto/" target = "_blank"><button type="button" class="btn btn-danger">Auto Systems Technology </button></a> 
	<a href = "http://tritechsc.org/programs/auto/" target = "_blank"><button type="button" class="btn btn-danger">Auto Systems Technology </button></a> 
...
welding
	...
	<a href = "http://tritech.ksd.org/"><img src="img/tritech.png" class="img-responsive" alt="tritech" ></a><a href = "http://tritechsc.org/programs/cyber/"><img src="img/cyber.png" class="img-responsive" alt="cyber" ></a><a href = "http://tritechsc.org/programs/teen/"><img src="img/teen.png" class="img-responsive" alt="teen" ></a>
